...
**Mapping canon:** [`../../admin-hub/registry-mapping-data-mcp.md`](../../admin-hub/registry-mapping-data-mcp.md) (agreed after Sub `protocol_ack`).
...
- Cipher: Argon2id + AES-256-GCM; parameters and test vector — in [`../../admin-hub/registry-mapping-data-mcp.md`](../../admin-hub/registry-mapping-data-mcp.md) § "Cipher test vector".
